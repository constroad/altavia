...
export const asphaltRowsArr = [
  { id: 1, 'Insumo': 'Arena Lurin', 'Dosis': 0.36, 'M3/GLS': 0, 'Precio': 53, 'Total': 0 },
  { id: 2, 'Insumo': 'Arena Telkus', 'Dosis': 0.24, 'M3/GLS': 0, 'Precio': 39, 'Total': 0 },
  { id: 3, 'Insumo': 'Piedra', 'Dosis': 0.40, 'M3/GLS': 0, 'Precio': 45, 'Total': 0 },
  { id: 4, 'Insumo': 'Petroleo', 'Dosis': 0.40, 'M3/GLS': 0, 'Precio': 14.80, 'Total': 0 },
  { id: 5, 'Insumo': 'PEN', 'Dosis': 24, 'M3/GLS': 0, 'Precio': 11.40, 'Total': 0 },
  { id: 6, 'Insumo': 'Gasohol', 'Dosis': 2, 'M3/GLS': 0, 'Precio': 8.50, 'Total': 0 },
  { id: 7, 'Insumo': 'Gas', 'Dosis': 0.125, 'M3/GLS': 0, 'Precio': 4.65, 'Total': 0 },
