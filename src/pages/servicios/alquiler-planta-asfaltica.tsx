      ...
      <Flex width='100%' pb='10px'>
        ...
        >
          ...
          >
            ...
            <Flex color='#707070' opacity={0.8} mt={{ base: '15px', md: '10px'}} textAlign='justify' className='font-roboto' flexDir={{ base: 'column', md: 'column' }} w='100%' justifyContent='space-between'>
